...
if(isset($_POST["get"]))
{
   ...
   $conne = mysql_connect($dbhost, $dbuser, $dbpass);
   if(mysqli_connect_error()){
   ...
   $sql = 'SELECT id, firstname, lastname, age, dob, gender, phonenumber,   FROM col';
   mysql_select_db('projectadmin');
   $retval = mysql_query( $sql, $conne );
		           ...
		           <div style="border-color: #fce8f1">
			         <div class="bg-info">
				          <form action="" method="post" name="myform">
					        ...
					        <button name="submit" id="submit" type="submit" value="submit" class="btn center btn-lg btn-block" style="background-color: #222">Submit</button>
